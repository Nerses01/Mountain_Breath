...
Go · chi · PostgreSQL · pgx · React 19 · TypeScript · Vite · Tailwind CSS ·
...
├── backend/       # Go API service            (Phase 1)
├── frontend/      # React + TypeScript app    (Phase 3)
├── deploy/        # Docker & nginx configs    (Phase 2+)
└── .github/       # CI workflows              (Phase 7)
```
