...
export const en = {
  ...
  account: {
    ...
    // ---- A5: the settings screen (canvas 10) -------------------------
    settingsScreen: {
      subtitle: 'Profile, language and what we send you.',
      edit: 'Edit',
      save: 'Save',
      change: 'Change',
      notSet: 'Not set yet',
      ...
      langCurrencyTitle: 'Language & currency',
      siteLanguage: 'Site language',
      showPrices: 'Show prices in',
      dualPrices: 'USD + AMD',
      notifTitle: 'Notifications',
      orderUpdates: 'Order updates',
      orderUpdatesDesc: 'Packed, shipped, delivered',
      harvestNotes: 'Harvest notes',
      harvestNotesDesc: 'Monthly, what we are jarring',
      harvestPending: 'Confirmation sent — check your inbox to finish.',
      wishlistAlerts: 'Wishlist alerts',
      wishlistAlertsDesc: 'Back in stock, member offers',
      smsTitle: 'SMS on delivery day',
      smsDesc: 'Courier window, +374 only',
      stubNote: 'These two are not wired up yet — each arrives with its sender.',
