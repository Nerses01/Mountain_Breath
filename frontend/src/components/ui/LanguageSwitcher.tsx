 ...
 * Language chooser.
 *
 * Removed post-A5 (decision #90) in favour of the settings screen, restored
 * by decision #98: the settings screen exists only behind a sign-in, and an
 * anonymous visitor had no control at all — the exact "anonymous traffic
 * suffers" condition #90 named as grounds for a new decision.
 *
